...
public class Buyanitem {
    public static void main(String[] args) {
        ...
        // buy item
        String buy_now_xpath = String.format("//div[@class='infoWrap'][.//h3[normalize-space()='%s']]//button[contains(@class, 'btn-primary')]",item_title);
        ...
        Assert.assertTrue(items_text.contains(item_title), "Item not in payment page");
